    ...
    >
      ...
      >
        ...
        >
          ...
          <Card w={"100%"} onClick={() => setSelectedDay(0)} cursor={"pointer"}>
            <CardHeader>
          ...
          <Card w={"100%"} onClick={() => setSelectedDay(1)} cursor={"pointer"}>
            <CardHeader>
          ...
          <Card w={"100%"} onClick={() => setSelectedDay(2)} cursor={"pointer"}>
            <CardHeader>
          ...
          {selectedDay === 0 && (
            <>
                ...
                <CardFooter>
                  <Box w={"100%"}>
                    ...
                    >
                      <AlertIcon />
                      <AlertTitle mr={2}>
                        A kvízshowra jelentkezés szükséges!
                      </AlertTitle>
                    </Alert>
                    <Link
                      href={
              ...
              <Card rounded="lg" size="sm" w={"100%"}>
                ...
                <CardBody pt={0}>
                  <Text fontStyle="italic" p={4} pt={0}>
                    ...
                    részében! Tarot kártya olvasás, számmisztika és tenyérjóslás
                    – tudd meg a jövőd!
                  </Text>
                  <Text>
              ...
              <Card rounded="lg" size="sm" w={"100%"}>
                ...
                <CardBody pt={0}>
                  <Text fontStyle="italic" p={4} pt={0}>
                    ...
                    iskola tanulóival is barátságos meccseket, melyek időtartama
                    10-10 perc. A meccseket fújni, a pontokat számolni fogják a
                    VPG tanulói, a szórakozás garantált!
                  </Text>
                  <Text>
              ...
              <Card rounded="lg" size="sm" w={"100%"}>
                ...
                <CardBody pt={0}>
                  <Text fontStyle="italic" p={4} pt={0}>
                    A VPG rajztermében csapatokban próbálhattok majd szerencsét.
                    Ha szeretsz csapatban dolgozni és nem ijedsz meg a
                    kihívásoktól, akkor ott a helyed. Ha nem fix csapattal
                    érkezel, az is teljesen rendben van.
                  </Text>
                  <Text>
                    <b>Időpont</b>: 15:45-17:00
                  </Text>
              ...
              <Card rounded="lg" size="sm" w={"100%"}>
                ...
                <CardBody pt={0}>
                  <Text fontStyle="italic" p={4} pt={0}>
                    A VPG-s program zárásaként lehetőséget adunk nektek, hogy a
                    többi programon szimpatikussá vált tanulókat közelebbről is
                    megismerhessétek különféle ismerkedős játékok keretében.
                  </Text>
                  <Text>
                ...
                <CardFooter>
                  <Box w={"100%"}>
                    ...
                    >
                      <AlertIcon />
                      <AlertTitle mr={2}>
                        A streetballra jelentkezés szükséges!
                      </AlertTitle>
                    </Alert>
              ...
              <Card rounded="lg" size="sm" w={"100%"}>
                ...
                <CardBody pt={0}>
                  <Text fontStyle="italic" p={4} pt={0}>
                    ...
                    különféle társasjátékokban összemérni tudásuk. Gyertek el és
                    játszatok barátaitokkal!
                  </Text>
                  <Text>
                    <b>Időpont</b>: 16:15-18:30
                  </Text>
              ...
              <Card rounded="lg" size="sm" w={"100%"}>
                ...
                <CardBody pt={0}>
                  <Text fontStyle="italic" p={4} pt={0}>
                    ...
                    maradsz le, mivel élő közvetítésen nézheted az esemenyeket!
                  </Text>
                  <Text>
                    <b>Időpont</b>: 16:15-18:30
                  </Text>
